    ...
    <div className={`${styles.root}`}>
      ...
      >
        <div className="container h-full relative default-grid">
          <div className="mt-60 md:mt-255 col-start-2 col-span-1 md:col-start-6 md:col-span-3">
            <Ring />
          </div>
          <div className="bottom-0 col-start-1 col-span-1 md:col-start-2 md:col-span-3 translate-x-50">
            <Ring />
          </div>
        </div>
      </div>
